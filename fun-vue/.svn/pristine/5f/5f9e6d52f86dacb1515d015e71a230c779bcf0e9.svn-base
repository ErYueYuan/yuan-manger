  ...
  <div class="bg7">
    ...
    <div class="main-container mar1 clearfix">
      ...
      <div class="index-top4">
        ...
        <div class="bg4 b-radius3 message-box mar7-1">
          <div class="border-b1 f1-2 pad5-3">{{achieveDate}}</div>
          <div class="border-b1" v-for="(item,index) in list" :key="index">
          <strong class="f2-1 pad5-3">{{item.productName}}</strong>
          <ul class="mar6-4 pad6-1 border-b">
            <li>
              <div class="f3 c5 c4 t-center">{{item.holderName}}</div>
              <div class="t-center f1 ">投保人</div>
            </li>
            <li>
              <div class="f3 c5 c4 t-center">{{item.paidPrem || 0}}</div>
              <div class="t-center f1 ">保费(万元)</div>
            </li>
            <li>
              <div class="f3 c5 c4 t-center">{{item.standPrem || 0}}</div>
              <div class="t-center f1 ">标保(份)</div>
            </li>
            <li>
              <div class="f3 c5 c4 t-center">{{item.spreadPrem || 0}}</div>
...
export default {
  ...
  methods: {
    ...
    getPremAchieve() {
      ...
      let times = `${year}-${month}`;
      if (this.datetype == "M") {
        _data.startDate = times;
        this.achieveDate = times;
      } 
