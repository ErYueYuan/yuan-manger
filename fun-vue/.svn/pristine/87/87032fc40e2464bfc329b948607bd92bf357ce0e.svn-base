  ...
  <div class="bg7">
    <div class="fun-top-panel bg-my  ">
      ...
      <span class="right"><b
          ...
          @click="$router.push({name:'searchResult'})"
        ></b></span>
    </div>
        ...
        <section class="my2020-nav-top  mnt1 bg7 ">
          <ul class=" f2 row mar0">
            ...
            <!-- <li class="col-4 pad1-1 none t-center none">
              <b class="f3 c5">{{adviserNum?adviserNum:0}}<span class="f1 c4">人</span></b>
      ...
      <section class="bg7 border-t">
        ...
        >
          <div
            ...
            :key="index"
            @click="goDetail(item.clientId,item.clientNewId,item.resultId)"
          >
            ...
            <div class="right-box posi2  c-p">
              ...
              <div class="f2 c4">
                <span>年龄：</span><span>{{item.age =="未知"?item.age:`${item.age}岁`}}</span>
              </div>
              <div class=" f2 c4">
                <span>客户星级：</span><span
                  class="stars-box"
                  v-if="item.customerStar"
                ><i
