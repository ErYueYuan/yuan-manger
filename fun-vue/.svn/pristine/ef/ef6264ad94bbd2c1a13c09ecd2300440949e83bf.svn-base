<template>
    <div>
        ...
        <div class="main-container mar3-7  clearfix">
            <section class="b-radius3 pad1-3 bg7 mar3-2">
                <dl class="per-box52 no-p  border-b">
                    <dt class="c6 f3-1">姓名<span class="f2 c8">&nbsp;*</span></dt>
                    <dd class="t-right f3  clearfix"><input type="text" class="ed-input  form-control h44 t-right" placeholder="请输入" v-model="createCustomerList.name"></dd>
                </dl>
                <dl class="per-box52 no-p  border-b">
                    <dt class="c6 f3-1">手机号码<span class="f2 c8">&nbsp;*</span></dt>
                    <dd class="t-right  f3 "><input type="text" class="ed-input form-control h44 t-right" placeholder="请输入" v-model="createCustomerList.mobile"></dd>
                </dl>
                <dl class="per-box52 no-p  border-b">
                ...
                <dl class="per-box52 no-p  border-b" @click="showDate()">
                    <dt class="c6 f3-1">出生日期</dt>
                    <dd class="t-right f3  arrow">
                        <input type="text" class="ed-input form-control h44 t-right" disabled placeholder="请选择" v-model="createCustomerList.birthday">
                    </dd>
                </dl>
                <dl class="per-box52 no-p  border-b" @click="showPicker('country')">
                    <dt class="c6 f3-1">国籍</dt>
                    <dd class="t-right f3  arrow">
                        <input type="text" class="ed-input form-control h44 t-right" disabled placeholder="请选择" v-model="createCustomerList.countryName">
                    </dd>
                </dl>
                <dl class="per-box52 no-p  " @click="showPicker('marry')">
                    <dt class="c6 f3-1">婚姻</dt>
                    <dd class="t-right f3  arrow">
                        <input type="text" class="ed-input form-control h44 t-right" disabled placeholder="请选择" v-model="createCustomerList.marryName">
                    </dd>
                </dl>
            </section>
        </div>
        <div class="pad5-9 posi1  bg7 border-t">
                <button type="button" class="hx-bt3 t-center"  @click="submit()">完成</button>
        </div>
