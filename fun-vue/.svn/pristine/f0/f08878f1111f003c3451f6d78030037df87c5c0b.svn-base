                ...
                <section class=" pad1-3  ">
                        ...
                        <section class="pad1">
                            ...
                            <dl class="per-box bg7 border-b1" @click="showPopup('sex')">
                                ...
                                <dd class="t-right f3  arrow">
                                    <input type="text" class="ed-input form-control h44 t-right" placeholder="请选择" disabled :value="customerSexName" ><!-- :value="customerDetail.sexName" -->
                                </dd>
                            </dl>
                        </section>
                    </section>
                    ...
                    <section class="mar3-6 bg7  b-sh1">
                        <section class="pad1">
                            <dl class="per-box bg7 border-b1" @click="showDate('birthday')">
                                ...
                                <dd class="t-right f3  arrow">
                                    <input type="text" class="ed-input form-control h44 t-right" placeholder="请选择" disabled :value="customerBirthday" ><!-- :value="customerDetail.birthday" -->
                                </dd>
                            </dl>
                            <dl class="per-box bg7 border-b1">
                    ...
                    <section class="mar3-6 bg7  b-sh1">
                        <section class="pad1">
                            ...
                            <dl class="per-box bg7 border-b1" @click="showDate('endDate')" v-if="customerDetail.cerType == '01' && customerDetail.cerValiddateType == '1'">
                            ...
                            <dl class="per-box bg7">
                                ...
                                <dd class="t-right f3  ">
                                    <input type="text" class="ed-input form-control h44 t-right" placeholder="请输入证件号码" v-model="customerDetail.cerCode" @blur="cardBlur(customerDetail.cerCode)">
                                </dd>
                            </dl>
                        </section>
                    </section>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCustomerDetail () {
                ...
                api_sell.getCustomerDetail(_data).then(data => {
                    if (data.status == tool.rtCode.status) {
                        ...
                        this.customerBirthday = data.customerDetail.birthday;
            ...
            cardBlur (number) {
                if (!!this.customerDetail.cerType) {
                    if (this.customerDetail.cerType == '01') {// && !!number && Vd.idcard(number, '请输入正确居民身份证号码')
                        if (!!number && Vd.idcard(number, '请输入正确居民身份证号码')) {
                            this.customerDetail.cerCode = number;
                            //出生日期
                            this.customerBirthday = number.substring(6, 10) + "-" + number.substring(10, 12) + "-" + number.substring(12, 14);

                            //性别
                            if (parseInt(number.substr(16, 1)) % 2 == 1) {
                                this.customerSex = "1";
                                this.customerSexName = "男";
                            } else if (parseInt(number.substr(16, 1)) % 2 != 1) {
                                this.customerSex = "0";
                                this.customerSexName = "女";
                            } else {
                                this.customerSex = "2";
                            ...
                            //年龄
                            let customerage;
                            let strBirthdayArr = this.customerBirthday.split("-");
                            ...
                            this.customerDetail.age = customerage;
                            return customerage;

                        } else {
                            this.customerDetail.cerCode = "";
                        }
                    } else {
                        this.customerDetail.cerCode = number;
                    }
                    ...
                    tool.toastMessage('请选择证件类型', 'error');
                }
            },
            ...
            updateCustomerDetail () {
                ...
                const _data = {
                    ...
                    sex: this.customerSex,//this.customerDetail.sex
                    mobile: this.customerDetail.mobile,
                    birthday: this.customerBirthday,//this.customerDetail.birthday
            ...
            selectContent (values, index) {
                ...
                if (values.type == 'cbs_sex') {
                    ...
                    // this.customerSex = values.value;
                    // this.customerSexName = values.name;
                    if (!!this.customerSex) {
                        if (values.value != this.customerSex) {
                            tool.toastMessage("请保证性别和证件号码一致", 'error');
                        } else {
                            this.customerSex = values.value;
                            this.customerSexName = values.name;
                        }
            ...
            confirm(val) {
                ...
                if(this.confirmType == 'birthday'){
                    ...
                    if (!!this.customerBirthday) {
                        if (value!=this.customerBirthday) {
                            tool.toastMessage("请保证出生日期和证件号码一致", 'error');
                        } else {
                            this.customerBirthday = value;
                        }
                    } else {
                    ...
                    // 计算年龄
                    let returnAge;
                    let strBirthdayArr = this.customerBirthday.split("-");//this.customerDetail.birthday
                    let birthYear = strBirthdayArr[0];
                    let birthMonth = strBirthdayArr[1];
                    let birthDay = strBirthdayArr[2];
