<template>
  <div>
    ...
    <share-panel :shareData="shareData" :showShare="showShare" @cancelShare="cancelShareFun"></share-panel>
  </div>
</template>
...
<script>
  ...
  import { TopPanel, SharePanel } from '@/components/index'
  ...
  export default {
    ...
    methods: {
      ...
      goShare() {
        if (tool.globalData.isWeiXin || tool.globalData.isApp) {
