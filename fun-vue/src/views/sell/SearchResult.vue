<template>
    <div class="bg7">
        ...
        <div class="main-container clearfix" v-if="!isShowResult">
            ...
            <section class="tab-box2" v-if="isShow">
...
<script>
    ...
    export default {
        ...
        created () {
            if (!!DataSource.get('searchName',2)) {
                this.getCustomerList();
                this.value = DataSource.get('searchName',2);
            }
        },
        mounted () {
            this.getsource();
        ...
        methods: {
            ...
            onSearch(val) {
                if (!!val) {
                    ...
                    this.searchName = val;
                    DataSource.set('searchName', this.searchName, 2)
            ...
            getCustomerList (val) {
                const _data = {
                    ...
                    offset: this.offset,
                    limit: this.limit,
                    name: !!DataSource.get('searchName', 2) ? DataSource.get('searchName', 2) : (!!val ? val : "")
                }
            ...
            queryHistory (name) {
                DataSource.set('searchName', name, 2)
