    ...
    <div class="bg7">
        ...
        <div>
            ...
            <add-friend v-if="isAddFriend"
                ...
                :customerPhone="customerBaseInfo.mobile"
...
<script>
    ...
    import { CustomerBasic, CustomerOrder, CustomerTrail, CustomerFollow, CustomerHistory, CustomerProduct, AddFriend } from '@/components/index'
    ...
    export default {
        ...
        methods: {
            ...
            plan() {
                ...
                window.location.href = tool.app.lzgUrl + '#/source/channelUserId=' + channelUserId + '&opType=5&status=' + identificationStatus + '&customerId=' + clientNewId + '&backPath=' + backPath + '&platformId=2724341dfdc5463cbf167f1195da6e3e&platformCode=12'
            },
            ...
            insure() {
                ...
                this.$router.push({ name: 'productList', params: {type: 0} })
            },
