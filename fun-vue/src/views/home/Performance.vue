      ...
      <div class="  message-box5 mar7-1">
        <ul class="b-radius3 bg4 ">
          <li class=" pad6-1 f2  ">
            ...
            <span class="sp2 f1 c4">新增标保</span>
            <span class="sp3 f1-1 c4 ">(万元)</span>
          </li>
          <li class="b-radius3 pad6-1 f2 mar7-2 bg4">
            <span class="sp1 f3 c5">{{yesterdayDate.sameDayPrem || 0}}</span>
            <span class="sp2 f1 c4">新增保费</span>
            <span class="sp3 f1-1 c4 ">(万元)</span>
          </li>
          <li class="b-radius3 pad6-1 f2 mar7-2 bg4">
            <span class="sp1 f3 c5">{{yesterdayDate.policy || 0}}</span>
            <span class="sp2 f1 c4">新增保单</span>
            <span class="sp3 f1-1 c4 ">(份)</span>
          </li>
          <li class="b-radius3 pad6-1 f2 mar7-2 bg4">
            <span class="sp1 f3 c5">{{yesterdayDate.extension || 0}}</span>
            <span class="sp2 f1 c4">预计佣金</span>
            <span class="sp3 f1-1 c4 ">(元)</span>
          </li>
        </ul>
      </div>
    </div>
        ...
        api_user.getAchievement(_data).then(data => {
          if (data.status === tool.rtCode.status) {
           ...
           if (achievementData.length > 0) {
            ...
            this.pieData.push({
              name: "其他",
              value: achievementData.length > 0 ? achievementData[0].other : 0,
            });
